        ...
        <div class="input-container name">
          ...
          <input type="text" id="usuario" name="username"
            value="<?php if (isset($_POST['username']))
              echo $_POST['username'] ?>" autocomplete="off"
              autocomplete="off">
          ...
          <div class="input-container password">
            ...
            <input type="password" id="contra" name="password"
              ...
              echo $_POST['password'] ?>"
              placeholder="Mínimo de 6 carácteres">
          ...
          <div class="input-container cta">            
            <div class="g-recaptcha" data-sitekey="6LfvexcpAAAAAMchCXdKzMo2HTZxn5U4eKoRHY4R">
            </div>
          </div>
          <br>
          ...
          <section class="copy legal">
            <p><span class="small">Ingenieria de Sistemas II</p>
