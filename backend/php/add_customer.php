...
swal("Error!", "Ya existe el registro a agregar!", "error").then(function() {
    ...
    {
      if (!isset($errMSG)) {
        $stmt = $connect->prepare("INSERT INTO clientes(tipd,nudoc,nocl,apcl,telfcl,state,username,password,rol) VALUES(:tipd,:nudoc,:nocl,:apcl,:telfcl,'1','username','password','2')");
